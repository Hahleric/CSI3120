...
let pi = 4.0 *. atan 1.0;;
let volume_cylinder (r:float) (h:float) : float = r *. r *. h *. pi;;
let v:float = volume_cylinder(2.0)(3.0);;
...
let g:bool = gt_10_chars("123124124124");;

(* 2. Compare the following two boolean values.  Why the difference? *)
(* let why1 = (1.0 = 1.0) *)
(* let why2 = (1.0 == 1.0) *)
(* let because = "= is assign and == is comparison"  *)
