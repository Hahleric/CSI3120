...
let max = max_of_list [1;2;7;4;5;6];;
...
ANSWER HERE
reduce: does something to every entry in a the list and gives an initial value

sum: return the sum of a list
product: return the product of every entry in a list
